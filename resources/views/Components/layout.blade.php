				...
				<div class="flex h-16 items-center justify-between">
					<div class="flex items-center">
						<div class="flex-shrink-0">
							<svg width="18" viewBox="0 0 71 62" fill="none" class="text-frameworks"
						...
						<div class="hidden md:block">
							<div class="ml-10 flex items-baseline space-x-4">
								...
								<x-nav-link href="/about" :active="request()->is('about')" :type="false">About
								</x-nav-link>
								...
								<div>
									<button type="button"
										...
										<img class="h-8 w-8 rounded-full"
											src="https://avatars.githubusercontent.com/u/61753745?v=4" alt="">
									</button>
								</div>
							</div>
						</div>
			...
			<div class="md:hidden" id="mobile-menu">
				...
				<div class="border-t border-gray-700 pb-3 pt-4">
					<div class="flex items-center px-5">
						...
						<div class="ml-3">
							<div class="text-base font-medium leading-none text-white">Simone Franceschetti</div>
